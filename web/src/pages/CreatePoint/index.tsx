...
const CreatePoint = () => {
    ...
    const [selectedUf, setSelectedUf] = useState('AL');
    const [cities, setCities] = useState<string[]>([]);
    const [selectedCity, setSelectedCity] = useState('0');
    const [initialPositon, setSelectedInitial] = useState<[number, number]>([0, 0]);
    ...
    useEffect(() => {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            setSelectedInitial([latitude, longitude]);
        })
    })
    ...
    function handleSetItem(id: number) {
        const hasItem = selectedItems.some(p => p === id);
        if (!hasItem) {
            setSelectedItems([...selectedItems, id]);
        }
        else {
            const filteredSeletedItems = selectedItems.filter(p => p !== id);
            setSelectedItems(filteredSeletedItems);
        }
    }
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <Map center={initialPositon} zoom={15}
                        onClick={(event: LeafletMouseEvent) => (setSelectedPosition([event.latlng.lat, event.latlng.lng]))}>
                        <TileLayer
