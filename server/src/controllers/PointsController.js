...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, city, uf, items, parsedItem, points, serializedPoints;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image: "http://192.168.1.27:3333/uploads/" + point.image });
                        });
    ...
    PointsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, city, uf, items, trx, point, ids, pointItems;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 4:
                        _b.sent();
                        return [2 /*return*/, response.json(__assign(__assign({}, point), { id: ids[0] }))];
                }
            });
        });
    };
    PointsController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, point, items, searializedPoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        items = _a.sent();
                        searializedPoint = __assign(__assign({}, point), { image: "http://192.168.1.27:3333/uploads/" + point.image });
